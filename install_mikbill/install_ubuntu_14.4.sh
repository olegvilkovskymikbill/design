...
apt-get -q -y install freeradius libfreeradius2 freeradius-mysql freeradius-utils freeradius-common libfreeradius-dev freeradius-dbg freeradius-iodbc logrotate >> log_install
...
log "cp -rf ../php5.3/* /var/www/mikbill/"
cp -rf ../php5.3/* /var/www/mikbill/ 2> /dev/null
